    ...
    <div className="flex flex-1 flex-col overflow-hidden">
      {language && (
        <div className="flex justify-end px-2 pt-1.5">
          <span className="rounded bg-green-100 text-green-700 dark:bg-green-900/50 dark:text-green-400 px-1.5 py-0.5 text-[10px] font-medium">
            {language}
          </span>
        </div>
      )}
      <div className="flex-1 overflow-hidden px-3 py-1.5">
        <pre className="whitespace-pre-wrap break-words font-mono text-[11px] leading-relaxed text-emerald-700 dark:text-emerald-300/90">
          {display}
        </pre>
      </div>
    </div>
